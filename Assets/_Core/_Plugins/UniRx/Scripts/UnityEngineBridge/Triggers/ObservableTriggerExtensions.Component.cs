...
namespace UniRx.Triggers
{
    ...
    public static partial class ObservableTriggerExtensions
    {
        ...
        public static IObservable<float> OnJointBreakAsObservable(this Component component)
        {
            if (component == null || component.gameObject == null) return Observable.Empty<float>();
            return GetOrAddComponent<ObservableJointTrigger>(component.gameObject).OnJointBreakAsObservable();
        }

        public static IObservable<Joint2D> OnJointBreak2DAsObservable(this Component component)
        {
            if (component == null || component.gameObject == null) return Observable.Empty<Joint2D>();
            return GetOrAddComponent<ObservableJointTrigger>(component.gameObject).OnJointBreak2DAsObservable();
        }
