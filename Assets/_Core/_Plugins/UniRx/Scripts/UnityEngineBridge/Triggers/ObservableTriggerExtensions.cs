...
namespace UniRx.Triggers
{
    ...
    public static partial class ObservableTriggerExtensions
    {
        ...
        public static IObservable<float> OnJointBreakAsObservable(this GameObject gameObject)
        {
            if (gameObject == null) return Observable.Empty<float>();
            return GetOrAddComponent<ObservableJointTrigger>(gameObject).OnJointBreakAsObservable();
        }

        public static IObservable<Joint2D> OnJointBreak2DAsObservable(this GameObject gameObject)
        {
            if (gameObject == null) return Observable.Empty<Joint2D>();
            return GetOrAddComponent<ObservableJointTrigger>(gameObject).OnJointBreak2DAsObservable();
        }
